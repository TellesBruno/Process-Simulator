...
public class CameraControlPrio : MonoBehaviour
{
    public float vel;
    public PrioridadesFIFO sceneController;
    // Start is called before the first frame update
    void Start()
    {
        sceneController = GameObject.FindGameObjectWithTag("GameController").GetComponent<PrioridadesFIFO>();
    }
